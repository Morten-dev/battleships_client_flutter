      ...
      child: InkWell(
        ...
        Row(
          ...
          children: <Widget>[
            ...
            const Spacer(),
            Container(margin:const EdgeInsets.all(10),child: Align( alignment: Alignment.centerRight ,child: Text(gameRoom.playerOne, style: const TextStyle(color: Colors.black)))),
          ],
        ),
      ),
    );
